...
VALUES (
    '${medName}', '${brand}', '${description}', 'Standard', ${price}, ${stock}, 20, '2028-12-31', ${requiresPrescription}, 'placeholder.jpg', (SELECT id FROM categories WHERE name = '${cat.name}'), true, 0
);\n`;
    });
});
